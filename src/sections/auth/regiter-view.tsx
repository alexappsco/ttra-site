...
//       .matches(/^[a-zA-Z0-9._]{3,}$/, t('Global.Validation.username_invalid')),
//     officialName: yup
//       .string()
...
//     setCurrentTab(watch('acceptTerms') ? 2 : 1);
//   };
...
//           });
//         } else if (res.error === 'email_already_exist') {
//           setError('email', {
//             type: 'server',
...
//           setError('root', {
//             type: 'server',
//             message: res.error || t('Global.Validation.system_error'),
//           });
//         }
//       });
//     }
...
//               <>
//                 <Image
//                   src="/assets/images/auth/new_register_step1_completed.svg"
//                   alt="step-2"
//                   width={400}
//                   height={83}
//                 />
...
//                   <FormControlLabel
//                     control={
//                       <Checkbox checked={acceptTerms} onChange={(e) => setValue('acceptTerms', e.target.checked)} />
//                     }
...
//                     ))}
//                   </Grid2>
//                   <Button fullWidth type="submit" variant="contained" disabled={!selectedBusiness.length || isSubmitting} sx={{ py: 1.5 }}>
//                     {t('Pages.Auth.create_new_account')}
//                   </Button>
//                   <Button fullWidth variant="outlined" onClick={handleBack} sx={{ py: 1.5 }}>
//                     رجوع
...
const FieldLabel = ({ children }: { children: string }) => (
  <Typography
    ...
    component="label" // Accessibility improvement
  >
    {children}
  </Typography>
);
            ...
            {currentTab === 0 && (
              <>
                ...
                <Stack spacing={2}>
                  ...
                  <Button fullWidth variant="contained" disabled={!isValid || isSubmitting} onClick={handleNext}>
                    التالي
                  </Button>
                </Stack>
              </>
            ...
            {currentTab === 1 && (
              <Stack spacing={2}>
                ...
                <FormControlLabel
                  ...
                  label="أوافق على الشروط والأحكام"
                />
                <Button fullWidth variant="contained" disabled={!acceptTerms} onClick={() => setCurrentTab(2)}>
                  التالي
                </Button>
            ...
            {currentTab === 2 && (
              <>
                ...
                <Stack spacing={2}>
                  ...
                  <Button fullWidth type="submit" variant="contained" disabled={!selectedBusiness.length || isSubmitting}>
                    {t('Pages.Auth.create_new_account')}
                  </Button>
                  <Button fullWidth variant="outlined" onClick={handleBack}>
                    رجوع
