...
export const InteractiveCardSection: React.FC = () => {
  ...
  const [expanded, setExpanded] = useState<'top' | 'left' | 'right' | null>(null);
  ...
  const glowAnimation = `
    @keyframes glow-dash {
      0% { stroke-dashoffset: 0; filter: drop-shadow(0px 0px 3px currentColor); opacity: 1; }
      50% { stroke-dashoffset: 20; filter: drop-shadow(0px 0px 6px currentColor); opacity: 0.7; }
      100% { stroke-dashoffset: 0; filter: drop-shadow(0px 0px 3px currentColor); opacity: 1; }
    }
  `;
