...
const DiamondCardRoot = styled(Box)(({ theme }) => ({
  ...
  [theme.breakpoints.down('sm')]: {
    width: 95,
    height: 95,
    '&:hover': { transform: 'rotate(45deg)', boxShadow: 'none' },
  },
  [theme.breakpoints.between('sm', 'md')]: {
    width: 150,
    height: 150,
    '&:hover': { transform: 'rotate(45deg) scale(1.05)', boxShadow: theme.shadows[6] },
  },
  [theme.breakpoints.between('md', 'lg')]: {
    width: 200,
    height: 200,
    '&:hover': { transform: 'rotate(45deg) scale(1.08)', boxShadow: theme.shadows[8] },
  },
  [theme.breakpoints.up('lg')]: {
    width: 260,
    height: 260,
  ...
  return (
    ...
    >
      <DiamondCardContent>
        ...
        <Typography
          variant="subtitle2"
          sx={{ fontWeight: 'bold', mt: 1, fontSize: { xs: 10, sm: 15 } }}
        >
          {title}
        </Typography>
