...
// >
//   <Grid size={{ xs: 12, md: 4, lg: 3 }} order={{ xs: 1, md: isArabic ? 1 : 4 }}>
//     <Typography
//       variant="h6"
//       sx={{
//         mb: 3,
...
//       alignItems={{
//         xs: 'center',
//         md: isArabic ? 'flex-start' : 'flex-end',
//       }}
//     >
//       <Box
//         sx={{
...
//   <Grid size={{ xs: 6, md: 2 }} order={{ xs: 3, md: 2 }}>
//     <Typography
//       variant="h6"
//       sx={{
//         mb: 3,
...
//   <Grid size={{ xs: 6, md: 2 }} order={{ xs: 4, md: 3 }}>
//     <Typography
//       variant="h6"
//       sx={{
//         mb: 3,
...
//   <Grid size={{ xs: 12, md: 4, lg: 3 }} order={{ xs: 2, md: isArabic ? 4 : 1 }}>
//     <Stack
//       spacing={2}
//       alignItems={{
//         xs: 'center',
